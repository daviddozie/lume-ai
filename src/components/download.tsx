                ...
                <div className="relative z-10 flex justify-between p-4 md:px-20 md:pt-30">
                    <div className="md:max-w-[45%]">
                        ...
                        <div className="mt-8 flex items-center md:gap-6 gap-2 w-full ">
                            ...
                            <Button className="md:w-[180px] w-full flex-1 text-[#F7F7FF] font-semibold font-inter h-[50px] rounded-[50px] py-2.5 md:px-[15px] px-2 bg-[linear-gradient(90deg,#0A0450_0%,#150B8E_50%,#0A0450_100%)] text-xs md:text-base shadow-[inset_0px_4px_10px_0px_#F7F7FF80] drop-shadow-[0px_4px_2px_0px_#F7F7FF26]">
                                See how it works
                            </Button>
                        </div>
                    </div>
