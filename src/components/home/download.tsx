    ...
    return (
        <div className="md:pt-13 pt-4 w-[90%] mx-auto mt-20">
            <div className="relative md:rounded-[50px] rounded-[20px]  overflow-hidden">
                ...
                <div className="relative z-10 flex justify-between p-6 md:px-20 md:pt-30">
                    <div className="md:max-w-[45%]">
                        ...
                        <div className="mt-8 flex items-center md:gap-6 gap-2 w-full ">
                            <Button className="border-2 border-[#3322FC] w-full flex-1 text-[#F7F7FF] font-semibold font-inter bg-[#5144EA] py-2.5 md:px-[15px] px-2 rounded-[50px] h-[50xp] md:w-[223px] shadow-[inset_0px_4px_4px_0px_#1907F180]">
                                Download App
                                <div className="noise py-1.5 px-2.5 h-[30px] bg w-[70px] flex items-center gap-4 rounded-[50px]">
